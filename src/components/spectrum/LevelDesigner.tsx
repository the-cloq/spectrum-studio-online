      ...
      <Card className="rounded-lg border bg-card text-card-foreground shadow-sm p-4 lg:col-span-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
          {levels.map((level, index) => {
            ...
            // Draw canvas thumbnail whenever the screen changes
            React.useEffect(() => {
            ...
            }, [currentScreenIndex, screensForLevel]);
          
            return (
              <Card key={level.id} className="relative p-4 border rounded flex flex-col gap-2">
                {/* Top Row */}
